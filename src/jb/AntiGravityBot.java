 ...
 * Storing absolute positions of EnemyB bots rather than relative ones
...
public class AntiGravityBot extends AdvancedRobot
{
	...
	EnemyB target;					//our current EnemyB
	...
	public void run() {
		...
		while(true) {
			...
			doGun();
			out.println(target.distance);	//move the gun to predict where the EnemyB will be
			fire(firePower);
	...
	/**Move the gun to the predicted next bearing of the EnemyB**/
	void doGun() {
		...
		//offsets the gun by the angle to the next shot based on linear targeting provided by the EnemyB class
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		if (targets.containsKey(e.getName())) {
			en = (EnemyB)targets.get(e.getName());
		} else {
			en = new EnemyB();
	...
	public void onRobotDeath(RobotDeathEvent e) {
		EnemyB en = (EnemyB)targets.get(e.getName());
		en.live = false;		
	}	
}
...
class EnemyB {
	...
	public boolean live; 	//is the EnemyB alive?
